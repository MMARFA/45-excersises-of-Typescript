...
if (alienColour === "green") {
    console.log("you shoot green alien you got 5 points");
    
}
else if(alienColour === "yellow"){
    console.log("you shoot yellow alien you got 10 points");
    
}
else if(alienColour === "red"){
    console.log("you shoot red alien you got 15 points");
